...
function LayoutInner() {
  ...
  return (
    <>
      <a href="#main-content" className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-1/2 focus:-translate-x-1/2 focus:z-[200] focus:bg-accent focus:text-bg focus:px-4 focus:py-2 focus:rounded-lg focus:shadow-lg focus:text-sm focus:font-medium">
        Skip to content
      </a>
      {disconnected && (
        <div role="alert" aria-live="assertive" className="fixed top-0 left-0 right-0 z-[100] bg-danger text-white text-center text-sm py-1.5 px-4">
